...
<div class="container mt-4">
    <h3 class="mb-4 text-center">Create a Parking Lot</h3>
    ...
    <form @submit.prevent="create_lot">
      ...
      <div class="text-center">
        <input type="submit" class="btn btn-success" value="Create a new Parking Lot"> |
...
methods: {
  create_lot() {
    ...
    axios.post("http://127.0.0.1:5000/api/create_lot", this.formData, {
      headers: {
